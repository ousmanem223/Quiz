...
const Questions = [{
    id: 0,
    q: "What's the Last Name of the President of the U.S.A?",
    a: [{ text: "Obama", isCorrect: false },
        { text: "Macron", isCorrect: false },
        { text: "Biden", isCorrect: true },
        { text: "Poutine", isCorrect: false }
    ]
...
},
{
    ...
    a: [{ text: "Saku", isCorrect: false, isSelected: false },
        { text: "Hashirama", isCorrect: false },
        { text: "Naruto", isCorrect: false },
        { text: "Hiruzen", isCorrect: true }
    ]

},
{
    id: 2,
    q: "Who is the latest Ballon D'Or Winner",
    a: [{ text: "Ronaldo", isCorrect: false },
        { text: "Lewandowski", isCorrect: false },
        { text: "Messi", isCorrect: true },
        { text: "Maguire", isCorrect: false }
    ]
